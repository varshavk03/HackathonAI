...
The translation code intentionally follows the original Colab notebook:
- OpenAI Whisper
- `task="translate"`
- `language="ta"`
- `word_timestamps=True`
- first/last word timestamps used for each subtitle
- overlap/zero-duration safety pass

Only the interface and subtitle appearance were changed. The subtitle font is now small (13 by default), bottom-centered, with a subtle black background. FFmpeg uses a faster encoding preset.
